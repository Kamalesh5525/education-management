    ...
    <div className="container my-4">
      ...
      <section className="mb-6">
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 border border-dark p-4 mb-3 border-4" style={{borderRadius:"15px",backgroundColor:"#A7E6FF"}}>
            <form className="mb-4">
      ...
      <section>
        ...
        {courses.map(course => (
          <div key={course.id} className="mb-4 border border-dark border-4 rounded p-3"style={{borderRadius:"15px",backgroundColor:"#A7E6FF"}} >
